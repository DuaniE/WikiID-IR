...
class MultiFileReader:
    ...
    # def read_from_local(self, file_name, bucket_name):
    #     self.bucket.storage.Client().get_bucket(bucket_name)
    #     blob = self.bucket.get_blob(f'postings_gcp/{file_name}')
    #     return blob.open("rb")

    def read(self, locs, n_bytes, drive):
        b = []
...
class InvertedIndex:  
    def __init__(self, docs={}):
        ...
        self.DL = {}  # We're going to update and calculate this after each document. This will be usefull for the calculation of AVGDL (utilized in BM25)
    ...
    def get_DL(self):
        ...
        Mainly for our BM-25 class that get this index class
        """
        return self.DL
    ...
    def write_a_posting_list(b_w_pl, bucket_name):
        ...
        writer = MultiFileWriter(".", bucket_id, bucket_name)
